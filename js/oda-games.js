...
// Multiplayer
{id:'connect4',emoji:'\u{1F534}',title:'Four in a Row',desc:'Drop 4 in a row to win!',file:'arcade/connect4/index.html',cat:'multiplayer',colors:['#ef4444','#fbbf24'],categories:['Multiplayer','Strategy']},
...
{id:'battleship',emoji:'\u{1F6A2}',title:'Sea Strike',desc:'Find and sink the fleet!',file:'arcade/battleship/index.html',cat:'multiplayer',colors:['#1e3a5f','#22d3ee'],categories:['Multiplayer','Strategy']},
{id:'uno',emoji:'\u{1F3B4}',title:'Color Cards',desc:'Match colors, empty your hand!',file:'arcade/uno/index.html',cat:'multiplayer',colors:['#ef4444','#fbbf24'],categories:['Multiplayer']},
...
{id:'fruitninja',emoji:'\u{1F52A}',title:'Fruit Slash',desc:'Slash fruits, get combos!',file:'arcade/fruitninja/index.html',cat:'arcade',colors:['#ef4444','#16a34a'],categories:['Action']},
...
{id:'suika',emoji:'\u{1F349}',title:'Fruit Merge',desc:'Drop & merge fruits!',file:'arcade/suika/index.html',cat:'puzzle',colors:['#16a34a','#ef4444'],categories:['Puzzle']},
{id:'simonsays',emoji:'\u{1F3B5}',title:'Color Recall',desc:'Watch, listen, repeat!',file:'arcade/simonsays/index.html',cat:'puzzle',colors:['#ef4444','#3b82f6'],categories:['Puzzle']},
...
// Word
{id:'wordle',emoji:'\u{1F4DD}',title:'Word Guess',desc:'Guess the word in 6 tries!',file:'arcade/wordle/index.html',cat:'word',colors:['#16a34a','#fbbf24'],categories:['Puzzle','Word']},
