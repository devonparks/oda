...
var Block = /** @class */ (function () {
    function Block(block) {
        ...
        this.dimension.width =
            this.targetBlock ? this.targetBlock.dimension.width : 10;
        this.dimension.height =
            this.targetBlock ? this.targetBlock.dimension.height : 2;
        this.dimension.depth =
            this.targetBlock ? this.targetBlock.dimension.depth : 10;
...
var Game = /** @class */ (function () {
    ...
    Game.prototype.endGame = function () {
        ...
        var s=parseInt(this.scoreContainer.innerHTML)||0;
        if(window.odaRewardCoins && s>0) window.odaRewardCoins(s);
    };
